...
public class BlockInit {
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25 = register(
            "original_color_window_25",
            () -> new TrainOpenableWindowBlock(
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25_SEALED = register(
            "original_color_window_25_sealed",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25B_WIDE = register(
            "original_color_window_25b_wide",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    1),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25B_SMALL = register(
            "original_color_window_25b_small",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25B_TOILET = register(
            "original_color_window_25b_toilet",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainSealedWindowBlock> ORIGINAL_COLOR_WINDOW_25B_WIDE_SEALED = register(
            "original_color_window_25b_wide_sealed",
            () -> new TrainSealedWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25B = register(
            "original_color_window_25b",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainPanelBlock> END_FACE_25B_ORIGINAL_UPPER = register(
            "end_face_25b_original_upper",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainPanelBlock> END_FACE_25B_ORIGINAL_UPPER_2 = register(
            "end_face_25b_original_upper_2",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<Train25BGEndFaceBlock> END_FACE_ORIGINAL_25G = register("end_face_25g_original",
            () -> new Train25BGEndFaceBlock(
                    BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<TopPanelSlabBlock> DIRECT_DRAINAGE_TOILET_ORIGINAL_25B = register(
            "direct_drainage_toilet_original_25b",
            () -> new TopPanelSlabBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25G_SMALL = register(
            "original_color_window_25g_small",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
            ...
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25G_SMALL_2 = register(
            "original_color_window_25g_small_2",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> ORIGINAL_COLOR_WINDOW_25G_SEALED_SMALL = register(
            "original_color_window_25g_sealed_small",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25G_TOILET = register(
            "original_color_window_25g_toilet",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25G_WIDE = register(
            "original_color_window_25g_wide",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
    ...
    public static final RegistryObject<TrainSealedWindowBlock> ORIGINAL_COLOR_WINDOW_25G_WIDE_SEALED = register(
            "original_color_window_25g_wide_sealed",
            () -> new TrainSealedWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
    ...
    public static final RegistryObject<TrainIsolationDoorBlock> ISOLATION_DOOR_25BG = register2("isolation_door_25bg",
            () -> new TrainIsolationDoorBlock(
                    BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> END_FACE_25G_ORIGINAL_UPPER = register(
            "end_face_25g_original_upper",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> END_FACE_25G_ORIGINAL_UPPER_2 = register(
            "end_face_25g_original_upper_2",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TopPanelSlabBlock> DIRECT_DRAINAGE_TOILET_ORIGINAL_25G = register(
            "direct_drainage_toilet_original_25g",
            () -> new TopPanelSlabBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<TrainDoorBlock> PANEL_25K_ORIGINAL_SLIDING_DOOR = register(
            "original_25k_sliding_door",
            () -> new TrainDoorBlock(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.WATER).strength(3.0f)
                    .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<TrainGlassPanelBlock> PANEL_25K_ORIGINAL_WINDOW = register(
            ...
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25K_WIDE = register(
            "original_color_window_25k_wide",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    1),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25K_SMALL = register(
            "original_color_window_25k_small",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> ORIGINAL_COLOR_WINDOW_25K_SEALED_SMALL = register(
            "original_color_window_25k_sealed_small",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25K_TOILET = register(
            "original_color_window_25k_toilet",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainSealedWindowBlock> ORIGINAL_COLOR_WINDOW_25K_WIDE_SEALED = register(
            "original_color_window_25k_wide_sealed",
            () -> new TrainSealedWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
    ...
    public static final RegistryObject<HXD3DPanelBlocks> CARPORT_25BGZKT_WATER_TANK = register(
            "carport_25bgzkt_water_tank",
            () -> new HXD3DPanelBlocks(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion(), 2),
            object -> () -> new BlockItem(object.get(),
    ...
    public static final RegistryObject<CarPortBlockBGKZ> CARPORT_25BGZK_AIR_CONDITION_ALL = register(
            "carport_25bgzk_air_condition_all",
            () -> new CarPortBlockBGKZ(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
    ...
    public static final RegistryObject<Train25GLadderBlock> LADDER_25K_ORIGIINAL = register(
            "ladder_25k_original_sliding",
            () -> new Train25GLadderBlock(
                    BlockBehaviour.Properties.of(Material.STONE, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
    ...
    public static final RegistryObject<TopPanelSlabBlock> DIRECT_DRAINAGE_TOILET_ORIGINAL_25K = register(
            "direct_drainage_toilet_original_25k",
            () -> new TopPanelSlabBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<DF11GMirrorCarportBlock> CARPORT_25BGZK_AIR_CONDITION_SIDE = register(
            "carport_25bgzk_air_condition_side",
    ...
    public static final RegistryObject<Train25KTEndFaceBlock> END_FACE_25K_ORIGINAL = register("end_face_25k_original",
            () -> new Train25KTEndFaceBlock(
                    BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> END_FACE_25K_ORIGINAL_UPPER = register(
            "end_face_25k_original_upper",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainPanelBlock> END_FACE_25K_ORIGINAL_UPPER_2 = register(
            "end_face_25k_original_upper_2",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<Train25BGEndFaceBlock> END_FACE_25K_ORIGINAL_RUBBER = register(
            "end_face_25k_original_rubber",
            () -> new Train25BGEndFaceBlock(
                    BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> END_FACE_25K_ORIGINAL_RUBBER_UPPER = register(
            "end_face_25k_original_rubber_upper",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainPanelBlock> END_FACE_25K_ORIGINAL_RUBBER_UPPER_2 = register(
            "end_face_25k_original_rubber_upper_2",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<TrainDoorBlock> PANEL_25T_ORIGINAL_SLIDING_DOOR = register(
            "original_25t_sliding_door",
            () -> new TrainDoorBlock(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.WATER).strength(3.0f)
                    .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<Train25GLadderBlock> LADDER_25T_ORIGIINAL = register(
            "ladder_25t_original_sliding",
            () -> new Train25GLadderBlock(
                    BlockBehaviour.Properties.of(Material.STONE, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
    ...
    public static final RegistryObject<TrainGlassPanelBlock> PANEL_25T_ORIGINAL_WINDOW = register(
            ...
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_BLUE = register(
            "original_color_window_25t_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_SEALED_BLUE = register(
            "original_color_window_25t_sealed_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_SMALL = register(
            "original_color_window_25t_small",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_SMALL_BLUE = register(
            "original_color_window_25t_small_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_BSP25T_SMALL_BLUE = register(
            "original_color_window_bsp25t_small_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_SEALED_SMALL = register(
            "original_color_window_25t_sealed_small",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_SEALED_SMALL_BLUE = register(
            "original_color_window_25t_sealed_small_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_BSP25T_SEALED_SMALL_BLUE = register(
            "original_color_window_bsp25t_sealed_small_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_TOILET = register(
            "original_color_window_25t_toilet",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_TOILET_BLUE = register(
            "original_color_window_25t_toilet_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_BSP25T_TOILET_BLUE = register(
            "original_color_window_bsp25t_toilet_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    0),
    ...
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_WIDE = register(
            "original_color_window_25t_wide",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    1),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_25T_WIDE_BLUE = register(
            "original_color_window_25t_wide_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    1),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainOpenableWindowBlock> ORIGINAL_COLOR_WINDOW_BSP25T_WIDE_BLUE = register(
            "original_color_window_bsp25t_wide_blue",
            () -> new TrainOpenableWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion(),
                    1),
    ...
    public static final RegistryObject<TrainSealedWindowBlock> ORIGINAL_COLOR_WINDOW_25T_WIDE_SEALED = register(
            "original_color_window_25t_wide_sealed",
            () -> new TrainSealedWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainSealedWindowBlock> ORIGINAL_COLOR_WINDOW_25T_WIDE_SEALED_BLUE = register(
            "original_color_window_25t_wide_sealed_blue",
            () -> new TrainSealedWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainSealedWindowBlock> ORIGINAL_COLOR_WINDOW_BSP25T_WIDE_SEALED_BLUE = register(
            "original_color_window_bsp25t_wide_sealed_blue",
            () -> new TrainSealedWindowBlock(
                    BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.GLASS).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
    ...
    public static final RegistryObject<TrainPanelBlock> WIDEPANEL_BSP25T_ORIGINAL_MID = register(
            ...
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> END_FACE_25T_ORIGINAL_UPPER = register(
            "end_face_25t_original_upper",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainPanelBlock> END_FACE_25T_ORIGINAL_UPPER_2 = register(
            "end_face_25t_original_upper_2",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<Train25BGEndFaceBlock> END_FACE_25T_ORIGINAL_RUBBER = register(
            "end_face_25t_original_rubber",
            () -> new Train25BGEndFaceBlock(
                    BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                            .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TrainPanelBlock> END_FACE_25T_ORIGINAL_RUBBER_UPPER = register(
            "end_face_25t_original_rubber_upper",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new BlockItem(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));

    public static final RegistryObject<TrainPanelBlock> END_FACE_25T_ORIGINAL_RUBBER_UPPER_2 = register(
            "end_face_25t_original_rubber_upper_2",
            () -> new TrainPanelBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    public static final RegistryObject<TopPanelSlabBlock> DIRECT_DRAINAGE_TOILET_ORIGINAL_25T = register(
            "direct_drainage_toilet_original_25t",
            () -> new TopPanelSlabBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).strength(3.0f)
                    .sound(SoundType.COPPER).requiresCorrectToolForDrops().noOcclusion()),
            object -> () -> new ToolTipsItemHelper(object.get(),
                    new Item.Properties().tab(Main.KUAYUE_NormalSpeedPassageCarriageTab)));
    ...
    public static final RegistryObject<GreenInsulationFenceBlock> GREEN_FENCE = register("green_fence",
            () -> new GreenInsulationFenceBlock(
                    BlockBehaviour.Properties.of(Material.CLAY, MaterialColor.STONE).strength(3.0f)
    ...
    public static final RegistryObject<TrainPanelBlock> WIDEPANEL_CR200J_MARSHALLED_MID = register2(
    ...
    public static final RegistryObject<TrainGlassPanelBlock> PANEL_CR200J_MARSHALLED_TOP = register2(
    ...
    public static final RegistryObject<TrainGlassPanelBlock> PANEL_CR200J_MARSHALLED_BOTTOM = register2(
    ...
    public static final RegistryObject<TopPanelSlabBlock> SLAB_CR200J_MARSHALLED_TOP = register2(
