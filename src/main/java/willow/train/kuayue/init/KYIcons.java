...
public class KYIcons extends AllIcons {

    public static final ResourceLocation ICON_ATLAS = Main.asResource("textures/gui/icons.png");
    ...
    public static final willow.train.kuayue.init.KYIcons
    ...
    public KYIcons(int x, int y) {
        super(x, y);
        iconX = x * 16;
        iconY = y * 16;
    }

    private static willow.train.kuayue.init.KYIcons next() {
        return new willow.train.kuayue.init.KYIcons(++x, y);
    }

    private static willow.train.kuayue.init.KYIcons newRow() {
        return new willow.train.kuayue.init.KYIcons(x = 0, ++y);
    }
