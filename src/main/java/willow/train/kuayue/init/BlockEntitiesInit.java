...
public class BlockEntitiesInit {
    ...
    // LazyRegistrar.create(ForgeRegistries.BLOCK_ENTITIES,
    // Main.MOD_ID);
    ...
    // public static final RegistryObject<BlockEntityType<MegaphoneBlockEntity>>
    // MegaphoneBlockEntity =
    // BLOCK_ENTITIES.register("megaphone_block_entity", () ->
    // BlockEntityType.Builder.of(MegaphoneBlockEntity::new,
    // BlockInit.MEGAPHONE.get()).build());
