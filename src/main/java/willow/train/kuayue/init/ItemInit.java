...
public class ItemInit {
    ...
    // 注册机
    public static final LazyRegistrar<Item> ITEMS = LazyRegistrar.create(Registry.ITEM, Main.MOD_ID);
    ...
    public static final RegistryObject<Item> TRAIN_DIET_1 = register("train_diet_1",
            () -> new Food1(new Item.Properties().tab(Main.KUAYUE_DIET).food(
                    new FoodProperties.Builder().nutrition(4).saturationMod(2.5F)
                            .effect(new MobEffectInstance(MobEffects.HUNGER, 1000, 0, false,
                                    true), 1.0F)
                            .effect(new MobEffectInstance(MobEffects.CONFUSION, 1000, 0,
                                    false, true), 1.0F)
                            .effect(new MobEffectInstance(EffectInit.NOODLE_SMELL.get(),
                                    2000, 0, false, true), 1.0F)
