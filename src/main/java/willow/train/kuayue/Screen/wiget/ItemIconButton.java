...
public class ItemIconButton extends Button {
    ...
    public static final ResourceLocation BUTTON_ICON = new ResourceLocation(Main.MOD_ID, "textures/gui/button_background.png");
    public static final ResourceLocation CHOSEN_BUTTON_ICON = new ResourceLocation(Main.MOD_ID, "textures/gui/chosen_button_background.png");

    ItemStack icon;
    public ItemIconButton(int pX, int pY, Component message,ItemStack icon, OnPress pOnPress, int x_offset, int y_offset) {
