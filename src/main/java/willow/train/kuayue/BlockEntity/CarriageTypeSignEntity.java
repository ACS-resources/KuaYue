...
public class CarriageTypeSignEntity extends BlockEntity implements MenuProvider {
    ...
    private final Component[] messages = new Component[]{Component.empty(), Component.empty(), Component.empty(), Component.empty(), Component.empty()};
    ...
    public boolean setMessages(String[] messages){
        ...
        this.messages[0] = Component.literal(messages[0]);
        this.messages[1] = Component.literal(messages[1]);
        this.messages[2] = Component.literal(messages[2]);
        this.messages[3] = Component.literal(messages[3]);
        this.messages[4] = Component.literal(messages[4]);
