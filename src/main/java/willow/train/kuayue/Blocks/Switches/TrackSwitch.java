...
public class TrackSwitch extends SingleBlockEntityEdgePoint {
    ...
    private Map<TrackSwitchBlock.SwitchState, Optional<TrackNodeLocation>> getExistingExits() {
        return Map.of(
                TrackSwitchBlock.SwitchState.NORMAL, Optional.ofNullable(straightExit),
                TrackSwitchBlock.SwitchState.REVERSE_LEFT, Optional.ofNullable(leftExit),
                TrackSwitchBlock.SwitchState.REVERSE_RIGHT, Optional.ofNullable(rightExit)
        );
    }
     ...
     */
    @ApiStatus.Internal
    public @Nullable TrackSwitchBlock.SwitchState getTargetState(TrackNodeLocation loc) {
    ...
    public EdgePointType<?> getType() {
        return KYEdgePointTypes.SWITCH;
    }
