...
public class BogeyCategoryHandlerClient {
    ...
    static final ResourceLocation MANAGE_FAVORITES_CATEGORY = Main.asResource("manage_favorites_category");
    ...
    public static void registerStyleCategory(String name, NonNullSupplier<? extends ItemLike> icon) {
        registerStyleCategory(Main.asResource(name), icon);
    }
    ...
    static void setSelectedStyle(@Nullable BogeyStyle style) {
        ...
        KYPackets.PACKETS.send(new BogeyStyleSelectionPacket(style));
    }
    ...
    public static void loadFavorites() {
        ...
        try {
            ...
            Main.LOGGER.error("Failed to load favorite styles", e);
        }
    }
    ...
    public static void saveFavorites() {
        ...
        try {
            ...
            Main.LOGGER.error("Failed to save favorite styles", e);
        }
    }
    ...
    public static void addIcon(BogeyStyle style, String name) {
        ICONS.put(style, Main.asResource("textures/gui/bogey_icons/"+name+"_icon.png"));
    }

    static {
        for (BogeyStyle style : AllBogeyStyles.BOGEY_STYLES.values()) {
            if (style.name.getNamespace().equals(Main.MOD_ID))
