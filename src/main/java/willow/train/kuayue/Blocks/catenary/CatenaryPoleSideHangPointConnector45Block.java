...
public class CatenaryPoleSideHangPointConnector45Block extends HorizontalBlockBase {

    public CatenaryPoleSideHangPointConnector45Block(Properties p_49795_) {
        super(p_49795_);
    }
