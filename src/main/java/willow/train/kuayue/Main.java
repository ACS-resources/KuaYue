...
public class Main implements ModInitializer, ClientModInitializer {
    ...
    public static final CreativeModeTab KUAYUE_MAIN = FabricItemGroupBuilder.build(asResource("item_group_main"), BlockInit.CR_LOGO.get().asItem()::getDefaultInstance);
    public static final CreativeModeTab KUAYUE_LOCOS = FabricItemGroupBuilder.build(asResource("item_locos"), ItemInit.LOCO_LOGOS.get()::getDefaultInstance);
    public static final CreativeModeTab KUAYUE_NormalSpeedPassageCarriageTab = FabricItemGroupBuilder.build(asResource("item_group_normal_speed_passage_carriage"), ItemInit.SERIES_25_LOGOS.get()::getDefaultInstance);
    public static final CreativeModeTab KUAYUE_DIET = FabricItemGroupBuilder.build(asResource("item_group_diet"), ItemInit.CA_25T.get()::getDefaultInstance);
    public static final CreativeModeTab KUAYUE_CATENARY = FabricItemGroupBuilder.build(asResource("item_group_catenary"), BlockInit.Catenary_Pole.get().asItem()::getDefaultInstance);
...
//    };
    ...
    protected void clientSetup() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_SEALED_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25B_SMALL.get(), RenderType.translucent());

        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25K_SEALED_SMALL.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25G_SMALL_2.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25G_SEALED_SMALL.get(), RenderType.translucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_BSP25T_WIDE_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_WIDE_BLUE.get(), RenderType.translucent());

        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25G_SMALL.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25G_WIDE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25B_WIDE_SEALED.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25G_WIDE_SEALED.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25K_WIDE_SEALED.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_WIDE_SEALED.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_WIDE_SEALED_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_BSP25T_WIDE_SEALED_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25K_SMALL.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25B_TOILET.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25G_TOILET.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25K_TOILET.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_TOILET.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_TOILET_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_BSP25T_TOILET_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_SMALL.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_SMALL_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_BSP25T_SMALL_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_SEALED_SMALL.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25T_SEALED_SMALL_BLUE.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_BSP25T_SEALED_SMALL_BLUE.get(), RenderType.translucent());



        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.ORIGINAL_COLOR_WINDOW_25_SEALED.get(), RenderType.translucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.PANEL_25T_MARSHALLED_SKIRT_SIDE.get(), RenderType.translucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockInit.WIDEPANEL_CR200J_MARSHALLED_MID.get(), RenderType.translucent());
